...
for i = init : N
    ...
    for k = 1 : M
        ...
        jacob_part = funJacobian_sysid_full_param_damp_fric(q(k,1),q(k,2),q(k,3),q(k,4),q(k,5),q(k,6),...
...
%%
save('matfiles/UR5e_result_arm.mat','THETA', 'transf', 'rank_W');