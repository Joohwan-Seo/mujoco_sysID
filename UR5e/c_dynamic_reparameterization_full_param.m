...
load('utils/ur5e_symbolic_DH.mat');
...
jacob_50 = [dq1; 0; 0; 0; 0; 0;];
jacob_51 = [0; dq2; 0; 0; 0; 0;];
jacob_52 = [0; 0; dq3; 0; 0; 0;];
jacob_53 = [0; 0; 0; dq4; 0; 0;];
jacob_54 = [0; 0; 0; 0; dq5; 0;];
jacob_55 = [0; 0; 0; 0; 0; dq6;];

jacob_56 = -[sign(dq1); 0; 0; 0; 0; 0];
jacob_57 = -[0; sign(dq2); 0; 0; 0; 0];
jacob_58 = -[0; 0; sign(dq3); 0; 0; 0];
jacob_59 = -[0; 0; 0; sign(dq4); 0; 0];
jacob_60 = -[0; 0; 0; 0; sign(dq5); 0];
jacob_61 = -[0; 0; 0; 0; 0; sign(dq6)];

jacob = [jacob, jacob_50, jacob_51, jacob_52, jacob_53, jacob_54, jacob_55, ...
        jacob_56, jacob_57, jacob_58, jacob_59, jacob_60, jacob_61];


tic
matlabFunction(jacob,'File','utils/funJacobian_sysid_full_param_damp_fric', ...
